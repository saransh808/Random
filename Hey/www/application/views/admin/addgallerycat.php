			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Gallery Category Here</h2>
						
					</div>
					<div class="box-content">
                    
                    	<?php echo form_open_multipart('admin/addgallerycataction',array('class'=>'form-horizontal'));?>
						<fieldset>
						       ...
						       <div class="control-group">
							    ...
							    <div class="controls">
                                  ...
                                  <?php echo form_input(array('name'=>'category','value'=>set_value('category'),'class'=>'input-xlarge focused','id'=>'focusedInput'));?>
