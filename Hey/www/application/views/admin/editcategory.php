			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Add Category Here</h2>
							...
							<?php echo form_hidden('id', $data->id); ?>
						       ...
						       <div class="control-group">
							    ...
							    <div class="controls">
                                  ...
                                  <?php echo form_input(array('name'=>'category','value'=>set_value('category', $data->category),'class'=>'input-xlarge focused','id'=>'focusedInput'));?>
