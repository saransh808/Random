						  ...
						  foreach($data as $mydata){
                              ...
                              <tr>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="editwravellers_specific/<?=$mydata->Id?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onClick="return confirm('Are You Sure To Delete This.')" href="deletewravellers_specific/<?=$mydata->Id?>">
