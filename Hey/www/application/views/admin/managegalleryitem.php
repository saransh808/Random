			...
			<div class="row-fluid">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Gallery Items</h2>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  foreach($data as $mydata){
                              ...
                              <tr>
								...
								<td class="center"><img src="<?=base_url();?>uploads/gallery/<?=$mydata->image?>" width="70"></td>
								...
								<td class="center">
									...
									<a class="btn btn-info" href="editgalleryitem/<?=$mydata->id?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onClick="return confirm('Are You Sure To Delete This.')" href="deletegalleryitem/<?=$mydata->id?>">
