          ...
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="acount-info">
                  <div class="account-sign-up">
                    <div class="account-heading">Log in with a social network</div>
                    <div class="social-sign-up">
                      <a href="<?=base_url()?>account/login/Facebook?redir=<?=@$_GET["redir"]?>" class="user-facebook"><i class="fa fa-facebook" aria-hidden="true"></i> Log in with Facebook</a>
                      <a href="<?=base_url()?>account/login/Google?redir=<?=@$_GET["redir"]?>" class="user-google"><i class="fa fa-google" aria-hidden="true"></i> Log in with Google</a>
                      <p>We will not post to Facebook/Google+ without checking with you first.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="acount-info">
                  <div class="account-sign-up">
                    <div class="account-heading">Log in with your email</div>
            ...
            <div class="user-extra">
              <div class="create-account">
                <p>Don't have an account? <a href="<?=base_url()?>account/signup?redir=<?=@$_GET['redir']?>">Sign up.</a></p>
              </div>
