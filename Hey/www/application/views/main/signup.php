          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col-lg-offset-4 col-md-offset-4">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="acount-info">
                  <div class="account-sign-up">
                    <div class="account-heading">Sign up with your email</div>
            ...
            <div class="user-extra">
              <div class="create-account">
                <p><a href="<?=base_url()?>account/signin?redir=<?=@$_GET['redir']?>"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back to login</a></p>
              </div>
