  ...
  <div class="container">
    <div class="user-panel-sec">
      <div class="user-panel-box">
        <div class="user-sec">
          <h1 class="text-center">Add Your Domestic Trip & its Description</h1>
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
              ...
              <?php echo form_open_multipart('', array('class' => 'form-1')); ?>
                ...
                <div class="form-group">
                  ...
                  <textarea rows="5" class="form-control" id="description" name="description" placeholder="Covered Places : List the places that can be covered during the trip"></textarea>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="numofdays" name="numofdays" placeholder="Enter number of Days">
