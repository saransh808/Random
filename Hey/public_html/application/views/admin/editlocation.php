						...
						<fieldset>
							<?php echo form_hidden('id', $data->id); ?>
						      ...
						      <div class="control-group">
							    ...
							    <div class="controls">
							      <?php echo form_dropdown('state', $state_dropdown, set_value('state',$data->state_id), array('id' => 'selectError4'));
									?>
						       ...
						       <div class="control-group">
							    ...
							    <div class="controls">
                                  ...
                                  <?php echo form_input(array('name'=>'location','value'=>set_value('location',$data->location),'class'=>'input-xlarge focused','id'=>'focusedInput'));?>
