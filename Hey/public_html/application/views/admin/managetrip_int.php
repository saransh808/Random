						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  foreach($data as $key => $mydata){
                              ...
                              <tr>
								...
								<td class="center">
									<a class="btn btn-success" href="activateInternationaltrip/<?=$mydata->id?>">
										<i class="halflings-icon white zoom-in"></i>  
									</a>
									<a class="btn btn-info" href="editInternationaltrip/<?=$mydata->id?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" onClick="return confirm('Are You Sure To Delete This.')" href="deleteInternationaltrip/<?=$mydata->id?>">
