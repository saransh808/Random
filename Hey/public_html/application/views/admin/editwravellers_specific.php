			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
                    	...
                    	<?php echo form_open_multipart('admin/editwravellers_specificaction',array('class'=>'form-horizontal'));?>
						<fieldset>
							...
							<div class="control-group">
							    ...
							    <div class="controls">
                                  ...
                                  <?php echo form_input(array('name'=>'Long','value'=>set_value('Long',$mydata->Longi),'class'=>'input-xlarge focused','id'=>'focusedInput'));?>
