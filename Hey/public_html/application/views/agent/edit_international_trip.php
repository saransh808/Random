  ...
  <div class="container">
    <div class="user-panel-sec">
      <div class="user-panel-box">
        <div class="user-sec">
          <h1 class="text-center">Edit Your Trip Description</h1>
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
              
              <?php echo form_open_multipart('', array('class' => 'form-1')); ?>
                <div class="btn-group" data-toggle="">                  
                  <a class="btn btn-type" href="<?=base_url()?>agent/addtrip">
                    Domestic
                  </a>
                  <a class="btn btn-type active" href="<?=base_url()?>agent/addtrip_international">
                    International
                  </a>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea rows="5" class="form-control" id="description" name="description" placeholder="Trip Description : Write about the trip and the place"><?=set_value('description', $trip[0]->description)?></textarea>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="numofdays" name="numofdays">
                    <option value="">Please select no. of days</option>
...
<script type="text/javascript">
       ...
       $('#country').val('<?=set_value('country', $trip[0]->country_id)?>').change();

        setTimeout(function(){
         
         $('#category').val('<?=set_value('category', $trip[0]->categoryid)?>').change();
         $('#numofdays').val('<?=set_value('numofdays', $trip[0]->numofdays)?>').change();
       }, 500);

        $('.delimg').click(function(){
          var imgname = $(this).attr('data-image');
          //alert(imgname);
          $.post("<?=base_url()?>ajax/deleteimg_international_trip", {imgname: imgname, id: <?=$trip[0]->id?>, agent_id: <?=$trip[0]->agent_id?>}, function(data){
